 ...
 * @author DarthVader
 */
public class ProdutoSaida2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Tela de movimentação de saída no estoque");
        setResizable(false);
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        if (jTextFieldProduto.getText().isEmpty() || jTextFieldQuantidade.getText().isEmpty()) {
            ...
            try {
                ...
                Logger.getLogger(ProdutoSaida2.class.getName()).log(Level.SEVERE, null, ex);
            } catch (SQLException ex) {
                Logger.getLogger(ProdutoSaida2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdutoSaida2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProdutoSaida2().setVisible(true);
            }
        });
    }
