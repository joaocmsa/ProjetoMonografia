 ...
 * @author DarthVader
 */
public class TabelaRelProdutos extends AbstractTableModel{

    private List<Estoque> linhas = new ArrayList<>();
    private String[] colunas = {"Código","Nome","Estoque","Quant. min","Fabricante", "Fornecedor"};
    ...
    public Object getValueAt(int linha, int coluna) {
        ...
        switch(coluna){
            ...
            case 3:
                return linhas.get(linha).getQuantidade_min();
            case 4:
